...
class Search extends React.Component {
  ...
  search = (text) => {
    ...
    let temp = this.products.filter((x) => x.name.toUpperCase().includes(lowerText) || x.category.toUpperCase().includes(lowerText))
    this.setState({
    ...
    return (
      <>
        ...
        <Header history={this.props.history}>
          ...
          <Input.Search placeholder='Search' onSearch={this.search} onChange={this.debounceSearch} enterButton />
          {/* <div>
            <Input
              placeholder="Search"
